...
import actions
from api import PrivateBin
from utils import PBinCLIException
...
def main():
    ...
    send_parser.set_defaults(func=actions.send)
    ...
    get_parser.set_defaults(func=actions.get)
    ...
    delete_parser.set_defaults(func=actions.delete)
